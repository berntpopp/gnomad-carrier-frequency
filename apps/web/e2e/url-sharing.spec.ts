...
test.describe('URL state roundtrip', () => {
  ...
  test('fresh page with shared URL restores wizard state to Step 4', async ({ page, context }) => {
    ...
    await expect(freshPage.getByTestId('step-results')).toBeVisible({ timeout: 20_000 })
