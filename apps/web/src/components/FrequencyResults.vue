  ...
  >
    ...
    <v-card-text>
      ...
      <v-alert
        ...
        class="mb-4"
      >
        Founder effect detected: Some populations show >{{ founderMultiplier }}x
      ...
      <v-table density="compact">
        ...
        <tbody>
          ...
          >
            ...
            <td>
              <v-chip v-if="pop.isFounderEffect" color="info" size="x-small">
                Founder effect
              </v-chip>
              <v-chip v-if="pop.isLowSampleSize" color="warning" size="x-small">
                Low sample
              </v-chip>
            </td>
          </tr>
...
const formatDefaultFreq = computed(() => `1:${Math.round(1 / defaultFreq)}`);
