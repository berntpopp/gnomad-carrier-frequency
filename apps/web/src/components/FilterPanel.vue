        ...
        <v-row dense>
          <v-col cols="12" md="6">
            <v-tooltip location="top">
              ...
              <span class="tooltip-text">
                <strong>Loss-of-Function High Confidence</strong>
                — currently
                {{ modelValue.lofHcEnabled ? "enabled" : "disabled" }}<br />
                Includes predicted loss-of-function variants (nonsense,
                frameshift, splice site) that pass gnomAD quality filters. These
                variants typically result in no protein product.
              </span>
            </v-tooltip>
          </v-col>
              ...
              <template #activator="{ props: tooltipProps }">
                <div v-bind="tooltipProps" class="d-flex align-center">
                  <v-switch
                    ...
                    hide-details
                    @update:model-value="
                      updateFilter('missenseEnabled', $event)
                    "
                  />
                </div>
              </template>
              <span class="tooltip-text">
                <strong>Missense Variants</strong>
                — currently
                {{ modelValue.missenseEnabled ? "enabled" : "disabled" }}<br />
                Includes single amino acid substitutions with ClinVar P/LP
                evidence. Not all missense variants are pathogenic.
              </span>
            </v-tooltip>
          </v-col>
          ...
          <v-col cols="12" md="6">
            <v-tooltip location="top">
              ...
              <span class="tooltip-text">
                <strong>ClinVar Pathogenic/Likely Pathogenic</strong>
                — currently
                {{ modelValue.clinvarEnabled ? "enabled" : "disabled" }}<br />
                Includes variants classified as Pathogenic or Likely Pathogenic
                in ClinVar. This captures known disease-causing variants that
                may not be predicted as LoF.
              </span>
            </v-tooltip>
          </v-col>
          ...
          <v-col cols="12" md="6">
            <v-tooltip location="top">
              <template #activator="{ props: tooltipProps }">
                <div v-bind="tooltipProps" class="d-flex align-start">
                  <v-slider
                    ...
                    :max="4"
                    :step="1"
                    :ticks="smAndDown ? undefined : starTickLabels"
              ...
              <span class="tooltip-text">
                <strong>ClinVar Review Stars</strong>
                — currently &ge;{{ modelValue.clinvarStarThreshold }}<br />
                0: Any assertion<br />
          ...
          <v-col cols="12">
            ...
            <v-tooltip location="top">
              ...
              <span class="tooltip-text">
                <strong>Conflicting Classifications</strong>
                — currently
                {{
                  modelValue.clinvarIncludeConflicting ? "enabled" : "disabled"
                }}<br />
          ...
          <v-col cols="12" md="6">
            <v-tooltip location="top">
              ...
              <span class="tooltip-text">
                <strong>P/LP Threshold</strong>
                — currently
                {{ modelValue.clinvarConflictingThreshold }}%<br />
                Minimum percentage of ClinVar submissions that must classify the
                variant as Pathogenic or Likely Pathogenic for it to be
                included.
              </span>
            </v-tooltip>
          </v-col>
