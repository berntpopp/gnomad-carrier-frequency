...
const { selectedGene, geneConstraint, constraintLoading } = useGeneSearch();
...
// Single code path for gene selection: handles both manual GeneSearch selection
// and programmatic selection via prefillGene (e.g., WelcomeCard quick-start).
// GeneSearch's @select emit is no longer used — this watcher is authoritative.
