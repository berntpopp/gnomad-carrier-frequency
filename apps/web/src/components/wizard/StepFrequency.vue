      ...
      <v-card-text>
        <v-window v-model="activeTab">
          ...
          <v-window-item value="default">
            ...
            <p class="text-body-2">
              Use this option when no gene-specific data is available, or as a
              conservative estimate for rare conditions.
            </p>
          </v-window-item>
        </v-window>
      </v-card-text>
...
const frequencyRules = [
  ...
  (v: string) => {
    ...
    return (
      (num > 0 && num <= 1) || "Must be between 0 and 1 (exclusive/inclusive)"
    );
  },
];
