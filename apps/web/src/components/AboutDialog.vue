    ...
    <v-card>
      ...
      <v-card-text>
        <div class="text-center mb-4">
          <v-icon size="64" color="secondary"> mdi-dna </v-icon>
        ...
        <p class="text-body-2 mb-4">
          A web-based research tool to calculate carrier frequencies for
          autosomal recessive conditions using gnomAD population data. For
        ...
        <div class="text-body-2"><strong>Author:</strong> Bernt Popp</div>
