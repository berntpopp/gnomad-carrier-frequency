...
**Success Criteria** (what must be TRUE):
  1. Running `make docs-dev` (or `bun run docs:dev`) serves a VitePress site at localhost with working navigation between Guide, Use Cases, Reference, and About sections
...
|-------|-----------|----------------|--------|-----------|
| 16. VitePress Setup | v1.3 | 0/TBD | Not started | - |
